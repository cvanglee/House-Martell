...
var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=FH40z8RM9VJhyEk0ML5R4TFfhpuV7uPV&q="+ emotion +"&limit=10"
      $.ajax({
          url: queryURL,
          method: "GET"
    ...
    var sayings = {
      ...
      nuetral:["ehhh...","The end doesn't justify the means","A rule isn't unfair if it applies to everyone","Give good and get good","If we do not maintain justice, justice will not maintain us"],
    ...
    $('#gitgiphy-image').append(emoticonImage);
    $('#gitgiphy-image').append(sayingDiv);
